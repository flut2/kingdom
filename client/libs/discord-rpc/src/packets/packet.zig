...
pub const Presence = struct {
    ...
    pub const Assets = struct {
        large_image: ?ArrayString(256) = null,
        large_text: ?ArrayString(128) = null,
        small_image: ?ArrayString(256) = null,
        small_text: ?ArrayString(128) = null,
    };
    ...
    state: ?ArrayString(128) = null,
    details: ?ArrayString(128) = null,
